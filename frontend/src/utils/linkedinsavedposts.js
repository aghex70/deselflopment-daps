...
const elementList = document.querySelectorAll(
  "body > div.application-outlet > div.authentication-outlet > div > main > section > div > div.scaffold-finite-scroll__content > div > ul > li > div > div > div > div.entity-result__content-inner-container.entity-result__content-inner-container--right-padding > a"
);
const hrefValues = [];
