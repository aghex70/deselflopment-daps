...
const TodosList = () => {
  ...
  const [ascendingPriorityIcon, setAscendingPriorityIcon] =
    useState(faArrowDown91);
  ...
  const [showCannotDeleteActiveTodoModal, setShowCannotDeleteActiveTodoModal] =
    useState(false);
        ...
        <ButtonGroup style={{ width: "100%" }}>
          ...
          {row.active === true ? (
            ...
            <Button
              ...
              title={EditIconText}
              variant="outline-primary"
              onClick={() => navigateToTodo(row.id, categoryId, 0, "edit")}
            >
          ...
          <Button
            ...
            onClick={() =>
              row.active
                ? toggleCannotDeleteStartedTodoModal()
                : toggleConfirmDeleteTodoModal(row.id)
            }
          >
  ...
  function indication() {
    return (
      <span className="createIcon" onClick={() => createTodo()}>
  ...
  return (
    <Container>
      ...
      <Modal
        className="deleteActiveTodoModal text-center"
        show={showCannotDeleteActiveTodoModal}
        open={showCannotDeleteActiveTodoModal}
        centered={true}
        size="lg"
      >
        <ModalBody>
