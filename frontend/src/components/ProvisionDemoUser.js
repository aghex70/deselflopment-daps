...
const ProvisionDemoUser = () => {
  ...
  const [showModalDemoUserAlreadyCreated, setShowModalDemoUserAlreadyCreated] =
    useState(false);
  ...
  const handleSubmit = (e) => {
    ...
    UserService.provisionDemoUser(userEmail, hashedPassword, userLanguage)
      .then((response) => {
  ...
  return (
    <Container>
      ...
      <Modal
        ...
        show={showModalDemoUserAlreadyCreated}
        open={showModalDemoUserAlreadyCreated}
        centered={true}
        size="lg"
      >
        <ModalBody>
      ...
      <Modal
        className="successModal text-center"
        show={showModalEmptyEmail}
        open={showModalEmptyEmail}
        centered={true}
        size="lg"
      >
        <ModalBody>
