...
const CreateCategory = () => {
  ...
  const [showModalCategoryAlreadyExists, setShowModalCategoryAlreadyExists] =
    useState(false);
  ...
  return (
    <Container>
      ...
      <Modal
        ...
        show={showModalCategoryAlreadyExists}
        open={showModalCategoryAlreadyExists}
        centered={true}
        size="lg"
      >
        <ModalBody>
      ...
      <Modal
        className="successModal text-center"
        show={showEnterCategoryModal}
        open={showEnterCategoryModal}
        centered={true}
        size="lg"
      >
        <ModalBody>
